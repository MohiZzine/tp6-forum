          ...
          <div class="flex items-start">
            <div class="flex-grow">
              ...
              <p class="text-sm text-[#818384] mb-2">
                Posted by u/{{ discussion.username }} {{ formatTimeAgo(discussion.createdAt) }}
              </p>
              ...
              <div class="mt-2 flex flex-wrap gap-2">
                <span 
                  ...
                  :key="index" 
                  class="bg-[#272729] text-[#FF4500] px-2 py-1 rounded-full text-sm"
                >
                  {{ tag }}
                  <button @click="removeTag(discussion.id, index)" class="ml-2 text hover:text-[#FF4500]">&times;</button>
                </span>
              </div>
